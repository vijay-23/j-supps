    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: Roc Flevoland.<br>
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:06-26328738">06-26328738</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:vhoelas@roc-dev.com" class="email__addr">vhoelas@roc-dev.com</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?> J-Supps&trade;
          </div>

          <div class="developer">
            Developed by Vijay Hoelas
          </div>

          <div class="designby">
            Design by Vijay Hoelas
          </div>
